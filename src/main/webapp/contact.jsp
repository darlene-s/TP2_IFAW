...
<div class="container pt-2 pb-5">
    <form class="container pt-2 pb-5" action="afficherContact.jsp" method="post">
        <fieldset>
            <legend class="mt-4">
            ...
            <div class="form-group">
                ...
                <input type="text" name="lastName" class="form-control" placeholder="Enter your Last name" id="LastName" maxlength="10" required>

                <label class="col-form-label mt-4" for="MiddleName">Middle Name</label>
                <input type="text" name="middleName" class="form-control" placeholder="Enter your middle name" id="MiddleName" maxlength="10" required>
                ...
                <div class="form-check mt-4">
                    ...
                    <label class="form-check-label" for="contact"> Contact ? (Yes/No) </label>
                </div>
            </div>
            <button type="submit" class="btn btn-success mt-4">Submit</button>
            <input type="reset" class="btn btn-warning mt-4" value="Reset">
            <button type="button" class="btn btn-info mt-4" onclick="changeValueById('LastName', 'Last name value changed')">Js Call</button>
        </fieldset>
    </form>
