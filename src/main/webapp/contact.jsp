...
<div class="container pt-2 pb-5">
	<form class="container pt-2 pb-5" action="contact" method="post">
		<fieldset>
			<legend class="mt-4">
			...
			<div class="form-group">
				...
				<input type="text" name="lastName" class="form-control"
					...
					value="Last Name" required> <label
					class="col-form-label mt-4" for="MiddleName">Middle Name</label> <input
					type="text" name="middleName" class="form-control"
					placeholder="Enter your middle name" id="MiddleName" maxlength="10"
					value="Middle Name" required> <label
					class="col-form-label mt-4" for="FirstName">First Name</label> <input
					type="text" name="firstName" class="form-control"
					placeholder="Enter your First name" id="FirstName" maxlength="10"
					value="First Name" required> <label
					class="col-form-label mt-4" for="Gender">Gender</label>
